package com.android.acadgild.batterybroadcastreceiver;
    ...
    */
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            */
            ...
            // Show the battery charged percentage text inside text view
            mTextViewPercentage.setText("Battery Level Remaining: " + mProgressStatus + "%");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mTextViewPercentage = (TextView) findViewById(R.id.tvPercentage);
    }
}
